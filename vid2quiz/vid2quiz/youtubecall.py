...
CLIENT_SECRETS_FILE = "vid2quiz/client_secrets.json"
...
def get_authenticated_service(args):
  ...
  with open("vid2quiz/youtube-v3-api-captions.json", "r", encoding="utf-8") as f:
    doc = f.read()
...
def call_youtube(video_id):
  ...
  temp = list_captions(youtube,video_id)
  for i in temp:
      if i['snippet']['language']=='en':
        captions = download_caption(youtube,i['id'],'srt')
